...
mixin _$DownloadsState {
  ...
  List<Downloads> get downloadImages => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      isLoading: isLoading == freezed
          ...
          : isLoading // ignore: cast_nullable_to_non_nullable
              as bool,
      downloadImages: downloadImages == freezed
...
class _$_DownloadsState implements _DownloadsState {
  const _$_DownloadsState(
      ...
      required final List<Downloads> downloadImages,
      required this.downloadFailureOrSuccessOption})
      : _downloadImages = downloadImages;

  @override
  final bool isLoading;
  final List<Downloads> _downloadImages;
  @override
  List<Downloads> get downloadImages {
  ...
  @override
  String toString() {
    return 'DownloadsState(isLoading: $isLoading, downloadImages: $downloadImages, downloadFailureOrSuccessOption: $downloadFailureOrSuccessOption)';
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_downloadImages),
